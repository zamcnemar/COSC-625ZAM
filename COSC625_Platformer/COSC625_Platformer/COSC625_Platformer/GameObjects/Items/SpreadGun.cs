...
namespace COSC625_Platformer.GameObjects.Items
{
    class SpreadGun : Item
    {
        ...
        public SpreadGun(Level level, Vector2 position)
        {
            this.level = level;
        ...
        {
            spriteTexture = Level.Content.Load<Texture2D>("Sprites/Items/Spreadgun");
